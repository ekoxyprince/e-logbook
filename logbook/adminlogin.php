...
if(isset($_POST['submit'])){
    ...
    if($output){
       ...
       if($user_access == true){
        ...
        header('location:/logbook/admin/index.php');
       }else{
...
<form method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF'])?>">
  ...
  <div class="form-group">
    ...
    <input type="name" name="name" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter username" required>
